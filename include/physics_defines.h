...
#define CUBE_FIRST_JUMP_HEIGHT 2.05 * BLOCKS_TO_VALUE
#define CUBE_FIRST_JUMP_SPEED sqrt(2 * CUBE_GRAVITY * CUBE_FIRST_JUMP_HEIGHT)

#define CUBE_JUMP_HEIGHT 2.15 * BLOCKS_TO_VALUE
...
#define CUBE_MINI_FIRST_JUMP_SPEED CUBE_FIRST_JUMP_SPEED * 0.78
#define CUBE_MINI_JUMP_SPEED CUBE_JUMP_SPEED * 0.78
...
#define CUBE_MINI_YELLOW_PAD_MAX_HEIGHT 2.85 * BLOCKS_TO_VALUE
...
#define UFO_MINI_JUMP_HEIGHT 1.0 * BLOCKS_TO_VALUE

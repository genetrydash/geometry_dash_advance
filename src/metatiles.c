...
//-banana again lmao
	...
	Metatile("CLIFF_RIGHT_EDGE_1",    TILE(0x233, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_RIGHT_EDGE_2",    TILE(0x234, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_RIGHT_EDGE_LONG_PT1",    TILE(0x235, 0, 0, 0), TILE(0x236, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_RIGHT_EDGE_LONG_PT2",    TILE(0x23b, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_LEFT",    TILE(0x232, 0, H, 0), TILE(0x231, 0, H, 0), TILE(0x23b, 0, H, 0), TILE(0x238, 0, H, 0), COL_FULL)
	Metatile("CLIFF_LEFT_EDGE_1",    TILE(0x000, 0, 0, 0), TILE(0x233, 0, H, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_LEFT_EDGE_2",    TILE(0x000, 0, 0, 0), TILE(0x234, 0, H, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_LEFT_EDGE_LONG_PT1",    TILE(0x236, 0, H, 0), TILE(0x235, 0, H, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)
	Metatile("CLIFF_LEFT_EDGE_LONG_PT2",    TILE(0x000, 0, 0, 0), TILE(0x23b, 0, H, 0), TILE(0x000, 0, 0, 0), TILE(0x000, 0, 0, 0), COL_NONE)

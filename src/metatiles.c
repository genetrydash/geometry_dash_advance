...
const SCR_ENTRY metatiles[][5] = {
    ...
    Metatile("SPIKE_UP",       SE_BUILD(0x53, 0, 0, 0), SE_BUILD(0x54, 0, 0, 0), SE_BUILD(0x55, 0, 0, 0), SE_BUILD(0x56, 0, 0, 0), COL_SPIKE_TOP)
    ...
    Metatile("SPIKE_DOWN",         SE_BUILD(0x55, 0, 0, V_FLIP), SE_BUILD(0x56, 0, 0, V_FLIP), SE_BUILD(0x53, 0, 0, V_FLIP), SE_BUILD(0x54, 0, 0, V_FLIP), COL_SPIKE_BOTTOM)
    Metatile("SPIKE_RIGHT",        SE_BUILD(0x57, 0, 0, 0),      SE_BUILD(0x58, 0, 0, 0),      SE_BUILD(0x59, 0, 0, 0),      SE_BUILD(0x5a, 0, 0, 0),      COL_SPIKE_RIGHT)
    Metatile("SPIKE_LEFT",         SE_BUILD(0x58, 0, H_FLIP, 0), SE_BUILD(0x57, 0, H_FLIP, 0), SE_BUILD(0x5a, 0, H_FLIP, 0), SE_BUILD(0x59, 0, H_FLIP, 0), COL_SPIKE_LEFT)
    Metatile("SMALL_SPIKE_BOTTOM", SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x5b, 0, 0, 0),      SE_BUILD(0x5c, 0, 0, 0),      COL_SMALL_SPIKE_BOTTOM)
    Metatile("SMALL_SPIKE_TOP",    SE_BUILD(0x5b, 0, 0, V_FLIP), SE_BUILD(0x5c, 0, 0, V_FLIP), SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      COL_SMALL_SPIKE_TOP)
    Metatile("SMALL_SPIKE_RIGHT",  SE_BUILD(0x5d, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x5e, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      COL_SMALL_SPIKE_RIGHT)
    Metatile("SMALL_SPIKE_LEFT",   SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x5d, 0, H_FLIP, 0), SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x5e, 0, H_FLIP, 0), COL_SMALL_SPIKE_LEFT)
    Metatile("GROUND_SPIKE_BOTTOM",SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x5f, 0, 0, 0),      SE_BUILD(0x60, 0, 0, 0),      COL_SMALL_SPIKE_BOTTOM)
    Metatile("GROUND_SPIKE_TOP",   SE_BUILD(0x5f, 0, 0, V_FLIP), SE_BUILD(0x60, 0, 0, V_FLIP), SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      COL_SMALL_SPIKE_TOP)
    Metatile("GROUND_SPIKE_RIGHT", SE_BUILD(0x61, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x62, 0, 0, 0),      SE_BUILD(0x00, 0, 0, 0),      COL_SMALL_SPIKE_RIGHT)
    Metatile("GROUND_SPIKE_LEFT",  SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x61, 0, H_FLIP, 0), SE_BUILD(0x00, 0, 0, 0),      SE_BUILD(0x62, 0, H_FLIP, 0), COL_SMALL_SPIKE_LEFT)
